...
#    @user = double(User)
#    allow(@user).to receive(:say_hello) { "say now" }  
#    login @user
#    :errors => stub("errors", :count => 0)
#    @user =  stub_model(User, :id=> "78",:name => "aa",
#     :email => "aaa@mail.com",:password => "e10adc3949ba59abbe56e057f20f883e")
  end
  
  # This should return the minimal set of attributes required to create a valid
  # User. As you add validations to User, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { {  :name => "aa", 
    :email => "aaa@mail.com",
           :password => "123456",
